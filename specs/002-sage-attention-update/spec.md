...
**Created**: 2026-01-31
**Status**: Complete
**Input**: User description: "Update the version of sage (sage attention 2) as well as add sage attention 3. Rebuild the images and test they are installed and working. https://github.com/pixeloven/SageAttention/releases/tag/v2.2.0-build.16"
...
As a ComfyUI user running the complete profile, I want SageAttention 2 to be updated to the latest version (v2.2.0-build.16) so that I have the most current optimizations and bug fixes.
...
- **FR-001**: System MUST install SageAttention 2 version 2.2.0 from the v2.2.0-build.16 release
...
- **SageAttention 2**: The existing attention optimization library, being updated to v2.2.0-build.16
...
- SageAttention 3 (sageattn3) v1.0.0 is available as a separate wheel in the same v2.2.0-build.16 release
